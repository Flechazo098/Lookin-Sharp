...
public class LookinSharp {
    ...
    public static final Identifier BASE_RANGE = Identifier.fromNamespaceAndPath(MOD_ID, "base_range");
    public static final Identifier BASE_REACH = Identifier.fromNamespaceAndPath(MOD_ID, "base_reach");
    public static final Identifier BASE_KNOCKBACK = Identifier.fromNamespaceAndPath(MOD_ID, "base_knockback");
    public static final Identifier BASE_MOVEMENT = Identifier.fromNamespaceAndPath(MOD_ID, "base_movement");
    public static final Identifier BASE_TOUGHNESS = Identifier.fromNamespaceAndPath(MOD_ID, "base_toughness");
